...
describe('DcatDataset', () => {
  ...
  it('Hub Page has default keyword when tags has empty string', function() {
    const noMetadata = cloneObject(datasetFromIndex)
    delete noMetadata._source.metadata
  ...
  it('Hub Page has default keyword when tags is empty', function() {
    const noMetadata = cloneObject(datasetFromIndex)
    delete noMetadata._source.metadata
    noMetadata._source.item.tags = []
  ...
  it('Hub Page has default keyword when tags is undefined', function() {
    const noMetadata = cloneObject(datasetFromIndex)
    delete noMetadata._source.metadata
